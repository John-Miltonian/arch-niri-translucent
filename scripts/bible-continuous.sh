#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
#   CONTINUOUS BIBLE VERSE UPDATER
#   Cycles through verses every 30 minutes
# ═══════════════════════════════════════════════════════════════════════════════

VERSES_FILE="${XDG_RUNTIME_DIR:-/tmp}/bible-verse-current"
...
echo "${verses[0]}" > "$VERSES_FILE"

# Cycle through verses
while true; do
    index=$((RANDOM % ${#verses[@]}))
    echo "${verses[$index]}" > "$VERSES_FILE"
